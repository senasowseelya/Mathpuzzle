...
public  void Leveleasy()
 {   
	...
	Color mycolor = new Color(102, 51, 1);
	 String[] s = new String[]{"3","2","4","","7","5","8","6","1"};
	for(i=0;i<9;i++)
	{
    ...
    for(i=1;i<=9;i++){
	   ...
	   labeleasy.setBounds(700,60,100,70);
...
{   
    ...
    for(i=1;i<=16;i++){
	   ...
	   labelmedium.setBounds(700,60,100,70);
	   MyTime time = new MyTime();
	   //method to refresh label with time.
...
{   
	...
	JPanel p=new JPanel(g);
	Color mycolor = new Color(102, 51, 1);
	 String[] s = new String[]{"4","5","21","16","7","11","22","3","17","6","20","15","10","24","2","19","23","13","1","12","","8","18","9","14"};
	for(i=0;i<25;i++)
	{
    ...
    for(i=1;i<=25;i++){
	   ...
	   labelhard.setBounds(700,60,100,70);
	   MyTime time = new MyTime();
	   //method to refresh label with time.
	   time.updateLabel(labelhard,4);
